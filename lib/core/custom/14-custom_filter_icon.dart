...
/// - Border radius: 8.r
/// - Svg: assets/icons_assets/main_icons_assets/filter_sliders.svg, 20.sp x 20.sp
class CustomFilterIcon extends StatelessWidget {
  static const String _svgPath = 'assets/icons_assets/main_icons_assets/filter_sliders.svg';
  ...
  Widget build(BuildContext context) {
    ...
    final String text = title ?? (isArabic ? 'تصفية' : 'Filter');
