///*************************** FILE INFO ****************************///
/// Purpose: International phone number field with country picker.
/// Moved from features/settings/presentation/ui/widgets/fields/ into
/// core/custom so non-settings modules can reuse it.
...
import 'package:grc_module/core/helper/main_helper/helpers.dart';
...
class IntlPhoneField extends StatefulWidget {
  ...
  const IntlPhoneField({
    ...
    @Deprecated('Search field text is now owned by the shared country picker') this.searchText = 'Search country',
...
class _IntlPhoneFieldState extends State<IntlPhoneField> {
  ...
  Future<void> _changeCountry() async {
    filteredCountries = _countryList;
    // Uses the shared picker from the shared country picker, which owns its own
    // search state and returns the chosen country instead of taking a
    // callback. Replaces the near-duplicate country_picker_dialog.dart.
