...
import 'package:demo_app/core/helper/form_builder_module/core/helpers/date_time_helper.dart';
import 'package:demo_app/core/helper/form_builder_module/core/services/form_navigator_service.dart';
...
// ✅ Use singleton service instead of global key
final _formNavigatorService = FormBuilderNavigatorService();
...
extension ContextExtension on BuildContext {
  ...
  void FormNavigateTo(String routeName, {Object? arguments}) {

    

    final result = _formNavigatorService.navigateTo(routeName, arguments: arguments);
  ...
  void pop() {
    ...
    if (_formNavigatorService.isReady) {
      _formNavigatorService.pop();
  ...
  void popToFirst() {
    ...
    if (_formNavigatorService.isReady) {
      _formNavigatorService.popToFirst();
...
extension NumberToArabic on String {
  ...
  String get doubleDigit {
    try {
      return padLeft(2, FormDateTimeHelper.formatInt(0));
    } catch (e) {
      return this;
    }
  }
  ...
  String replaceAllDigitsWithZero() {
    ...
    for (var digit in digits) {
      result = result.replaceAll(digit, FormDateTimeHelper.formatInt(0));
    }
    return result;
  }
...
extension IntToOrdinal on int {
    ...
    switch (this) {
      ...
      default:
        return (Get.locale!.languageCode == 'en')
            ...
            : (this + 1).toString().toArabicNumbers() + 'th'.tr;
    }
  }
  ...
  String formatNumber() {
    ...
    if (Get.context!.isArabic) {
      return FormDateTimeHelper.formatInt(int.parse(
