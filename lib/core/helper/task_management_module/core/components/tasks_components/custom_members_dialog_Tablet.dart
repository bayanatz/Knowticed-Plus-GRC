...
class CustomMemberDialogTablet extends StatefulWidget {
  ...
  const CustomMemberDialogTablet({
    super.key,
    this.onApplyPressed,
    required this.board,
  ...
  @override
  _CustomMemberDialogTabletState createState() =>
      _CustomMemberDialogTabletState();
}

class _CustomMemberDialogTabletState extends State<CustomMemberDialogTablet> {
