...
import 'package:demo_app/features/calender/presentation/ui/pages/calendar_screen.dart';
import 'package:demo_app/features/calender/utiles/src/controller.dart';
import 'package:demo_app/features/calender/utiles/src/widget.dart';
import 'package:demo_app/features/calender/data/data_source/calendar_data_service.dart';
      ...
      children: [
            ...
            child: Row(
              children: [
                ...
                InkWell(
                  ...
                  child: SizedBox(
                    child: CustomSvg(
                      assetPath: isArabicMode ? "assets/icons_assets/calender_assets/right_arrow_calnder.svg" : "assets/icons_assets/calender_assets/left_arrow_calnder.svg",
                      width: 15.w,
                      height: 15.h,
                      fit: BoxFit.fill,
                    ),
                ...
                InkWell(
                  ...
                  child: CustomSvg(
                    assetPath: isArabicMode ? "assets/icons_assets/calender_assets/left_arrow_calnder.svg" : "assets/icons_assets/calender_assets/right_arrow_calnder.svg",
                    width: 15.w,
                    height: 15.h,
                    fit: BoxFit.fill,
                  ),
        ...
        Expanded(
          ...
          child: customButtonWithImageMas(
            ...
            image: 'assets/icons_assets/calender_assets/expand_calender.svg',
            widthImage: 16,
            heightImage: 16,
    ...
    return Column(
      children: [
        ...
        events.isEmpty
            ? Expanded(
          child: Lottie.asset(
            "assets/lottie_assets/main_lottie_assets/calaender.json",
            fit: BoxFit.fill,
            repeat: true,
          ),
        )
