...
import 'package:grc_module/features/grc/assignment_control/presentation/ui/pages/assignment_control_details_page.dart';
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              PaginationAppBar(
                screensTitles: [S.of(context).grc, S.of(context).assignmentControls],
              ),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: filtered.isEmpty
                              ? Center(
                                  child: Text(S.of(context).noControlsInThisStatus))
                              : GridView.builder(
                                  gridDelegate:
