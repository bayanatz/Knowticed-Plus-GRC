...
import 'package:demo_app/features/grc/control/presentation/ui/pages/assignee_bulk_upload/assignee_bulk_upload_preview_page.dart';
...
class _AssigneeBulkUploadPageState extends State<AssigneeBulkUploadPage> {
  ...
  Future<void> _onDragDone(DropDoneDetails details) async {
    ...
    if (!lowerName.endsWith('.xlsx') && !lowerName.endsWith('.xls')) {
      setState(
          () => _errorMessage = 'Please drop an Excel file (.xlsx or .xls)'.tr);
      return;
    }
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              PaginationAppBar(
                screensTitles: ['GRC'.tr, '${widget.assigneeLabel} Bulk Upload'.tr],
              ),
