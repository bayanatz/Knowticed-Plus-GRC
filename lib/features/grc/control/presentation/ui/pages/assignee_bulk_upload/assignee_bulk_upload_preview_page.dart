...
class _AssigneeBulkUploadPreviewPageState
  ...
  Future<void> _onActivate(AssigneeBulkUploadCubit cubit) async {
    ...
    await showConfirmDialog(
      context: context,
      title: 'Activate ${widget.assigneeLabel}s'.tr,
      subtitle:
          'Are you sure you want to activate these ${widget.assigneeLabel} assignments?'
              .tr,
              ...
              child: Column(
                ...
                children: [
                  PaginationAppBar(
                    screensTitles: [
                      'GRC'.tr,
                      '${widget.assigneeLabel} Bulk Upload Preview'.tr
                    ],
                  ),
