...
import 'package:grc_module/features/grc/control/presentation/ui/pages/control_bulk_upload/control_bulk_row_form.dart';
import 'package:grc_module/features/grc/control/presentation/ui/pages/control_bulk_upload/control_bulk_upload_cubit.dart';
import 'package:grc_module/features/grc/control/presentation/ui/pages/control_bulk_upload/control_bulk_upload_rows.dart';
        ...
        if (state is ControlBulkUploadSubmitResult) {
          if (state.succeededCount > 0) {
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                  '${state.succeededCount} ${S.of(context).controlSCreated}',
                ),
              ),
            );
          }
          ...
          body: SafeArea(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  PaginationAppBar(
                    screensTitles: [S.of(context).grc, S.of(context).controlBulkUploadPreview],
                  ),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Text(
                '${S.of(context).totalWeight} : ${total.toStringAsFixed(0)}',
