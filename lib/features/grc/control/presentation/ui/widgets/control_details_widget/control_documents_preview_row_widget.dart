...
class ControlDocumentsPreviewRowWidget extends StatelessWidget {
  ...
  Widget _documentCard(String url, String title) => Expanded(
        child: Container(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          if (hasEn)
            _documentCard(documentEnUrl!, S.of(context).controlDocumentEng),
          if (hasEn && hasAr) SizedBox(width: 12.w),
          if (hasAr)
            _documentCard(documentArUrl!, S.of(context).controlDocumentAr),
        ],
      ),
    );
  }
