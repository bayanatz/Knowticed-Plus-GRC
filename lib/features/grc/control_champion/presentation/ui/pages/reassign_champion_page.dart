...
class _ReassignChampionPageState extends State<ReassignChampionPage> {
  ...
  Future<void> _submit(BuildContext context) async {
    ...
    if (state is GrcRequestActionSuccess) {
      showSuccessDialog(
        ...
        subtitle: S.of(context).yourReassignChampionRequestHasBeenSubmitted,
      );
            ...
            children: [
              PaginationAppBar(
                screensTitles: [
                  ...
                  S.of(context).reassignControlChampionRequest,
                ],
              ),
              Expanded(
  ...
  List<Widget> _buildCurrentChampionSection({
    ...
    return [
      Text(S.of(context).currentControlChampion,
          style: StyleText.fontSize16Weight600.copyWith(color: AppColors.text)),
      SizedBox(height: 8.h),
      ContactCard(
        name: currentName,
        jobTitle: currentTitle.isNotEmpty ? currentTitle :grcTr(context, grcMockJobTitleFallback),
        department: currentDept.isNotEmpty ? currentDept :grcTr(context, grcMockDepartmentFallback),
  ...
  List<Widget> _buildNewChampionSection() {
    return [
      Text(S.of(context).newControlChampion,
          style: StyleText.fontSize16Weight600.copyWith(color: AppColors.text)),
      SizedBox(height: 8.h),
      Container(
