          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    '${S.of(context).requestType}: ${request.type.value}',
                    style: StyleText.fontSize12Weight600
                        .copyWith(color: AppColors.text),
                  ),
                ),
                Text(
                  '${S.of(context).RequestDate}: ${dateFormat.format(request.requestDate)}',
            ...
            GrcOwnerBadge(
              ...
              label: '${S.of(context).departmentManager}:',
            ),
            SizedBox(height: 15.h),
            Expanded(
              child: Text(
                '${S.of(context).request_note}: ${request.note}',
                maxLines: 1,
                      ...
                      children: [
                        ...
                        Expanded(
                          child: filtered.isEmpty
                              ? Center(child: Text(S.of(context).sm_noRequestsFound))
                              : GridView.builder(
                                  gridDelegate:
