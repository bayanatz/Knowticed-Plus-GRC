...
class _GovernanceRiskAndCompliancePageState
      ...
      items: module.isRemoved
          ...
          : [
              ...
              PopupMenuItem<String>(
                ...
                child: Text(S.of(context).previousModuleOwners),
              ),
              PopupMenuItem<String>(
                value: 'delete',
          ...
          body: SafeArea(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  PaginationAppBar(
                      screensTitles: [S.of(context).governanceRiskCompliance]),
  ...
  Widget _buildActionBar(BuildContext context) {
    ...
    final createButton = customButtonWithSvg(
      ...
      title: isTablet ? S.of(context).createGrcModule : '',
      textStyle:
  ...
  Widget _buildBody(
    ...
    if (modules.isEmpty) {
      return Center(
        child: Text(
          S.of(context).noGrcModulesFound,
