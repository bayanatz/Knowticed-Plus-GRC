      ...
      children: [
        ...
        Row(
          children: [
            ...
            _actionButton(
              label: _isEditing ? S.of(context).status_done : S.of(context).Edit,
      ...
      children: [
        Center(
          child: Container(
            ...
            child: Text(
              '${S.of(context).totalWeight} : ${total.toStringAsFixed(total.truncateToDouble() == total ? 0 : 1)}',
