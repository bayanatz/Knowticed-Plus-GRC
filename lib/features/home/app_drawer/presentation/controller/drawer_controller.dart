  ...
  class AppDrawerController extends GetxController {
    ...
    onInit() async {
      ...
      Mode.owner = _isAdminRole(employeeRoleName);
      Mode.hr = employeeRoleName.toLowerCase() == 'hr';
    ...
    void saveCustomOrder(List<Modules> newOrder) {
      try {
        ...
        update([AppDrawerUpdateIds.drawer]);
    ...
    void _getAllowedDrawerModules() {
      ...
      // print("🔧 Drawer: Mode.owner: ${Mode.owner}, Mode.hr: ${Mode.hr}");

      if (Mode.owner || Mode.hr) {
