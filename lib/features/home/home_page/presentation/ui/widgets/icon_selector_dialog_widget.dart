...
// REMOVED_MODULE: import 'package:demo_app/features/inventory_module/category/presentation/ui/tablet/s7_dashboard/p7_dashboard/p7_dashboard_toogel.dart';
...
class HeaderIconItem {
  ...
  static List<HeaderIconItem> getAllAvailableIcons(BuildContext context) {
    return [
      ...
      HeaderIconItem(
        svgPath: 'assets/icons_assets/home_assets/create_todo.svg',
        getTitle: (ctx) => S.of(ctx).createToDo,
        navigateTo: (context) => const Placeholder(),
      ),
      HeaderIconItem(
        svgPath: 'assets/icons_assets/home_assets/create_task.svg',
        getTitle: (ctx) => S.of(ctx).createTask,
        navigateTo: (context) => const Placeholder(),
      ),
      HeaderIconItem(
        svgPath: 'assets/icons_assets/home_assets/check_in_out.svg',
  ...
  static HeaderIconItem? fromSvgPath(String svgPath) {
    const validPaths = [
      'assets/icons_assets/home_assets/roles.svg',
      'assets/icons_assets/home_assets/user_access.svg',
      'assets/icons_assets/home_assets/user_mangemnt.svg',
      'assets/icons_assets/home_assets/english.svg',
      'assets/icons_assets/home_assets/light_dark.svg',
      'assets/icons_assets/home_assets/services_dashboard.svg',
      'assets/icons_assets/home_assets/inventory_dashboard.svg',
      'assets/icons_assets/home_assets/qias_dashboard.svg',
      'assets/dailog/services_approval.svg',
      'assets/icons_assets/home_assets/create_todo.svg',
      'assets/icons_assets/home_assets/create_task.svg',
      'assets/icons_assets/home_assets/check_in_out.svg',
    ];
    ...
    return HeaderIconItem(
      ...
      getTitle: (ctx) {
        final l = S.of(ctx);
        switch (svgPath) {
          case 'assets/icons_assets/home_assets/roles.svg':              return l.roles;
          case 'assets/icons_assets/home_assets/user_access.svg':        return l.userAccess;
          case 'assets/icons_assets/home_assets/user_mangemnt.svg':      return l.userManagement;
          case 'assets/icons_assets/home_assets/english.svg':            return l.english;
          case 'assets/icons_assets/home_assets/light_dark.svg':         return l.lightDarkMode;
          case 'assets/icons_assets/home_assets/services_dashboard.svg': return l.serviceDashboard;
          case 'assets/icons_assets/home_assets/inventory_dashboard.svg':return l.inventoryDashboard;
          case 'assets/icons_assets/home_assets/qias_dashboard.svg':     return l.qiyasDashboard;
          case 'assets/dailog/services_approval.svg':  return l.serviceApprovals;
          case 'assets/icons_assets/home_assets/create_todo.svg':        return l.createToDo;
          case 'assets/icons_assets/home_assets/create_task.svg':        return l.createTask;
          case 'assets/icons_assets/home_assets/check_in_out.svg':       return l.checkInOut;
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Center(
                    child: CustomSvg(
                      assetPath: "assets/icons_assets/home_assets/grid.svg",
                      width: 14.sp,
                      height: 14.sp,
