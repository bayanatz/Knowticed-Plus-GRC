...
// REMOVED_MODULE: import 'package:demo_app/features/todo_new_module/external/tasks_module/category/presentation/screens/to_do_list/home_screen.dart';
// REMOVED_MODULE: import 'package:demo_app/features/todo_new_module/external/tasks_module/core/enums/task_priority_enum.dart';
// REMOVED_MODULE: import 'package:demo_app/features/todo_new_module/external/tasks_module/core/enums/task_status_enum.dart';
                ...
                Column(
                  ...
                  children: [
                    item(
                      color: AppColors.red,
                      number: '${stats['high']}',
                      icon: 'assets/icons_assets/home_assets/hight.svg',
                    ),
                    item(
                      color: AppColors.yellow,
                      number: '${stats['medium']}',
                      icon: 'assets/icons_assets/home_assets/mudium.svg',
                    ),
                    item(
                      color: AppColors.green,
                      number: '${stats['low']}',
                      icon: 'assets/icons_assets/home_assets/low.svg',
                    ),
                  ],
                ),
                const SizedBox.shrink(),
