/// ************************* FILE INFO ************************* ///
/// File Name: role_management_notification_pages.dart
/// Purpose: Target pages a notification from the Role Management module can
...
enum RoleManagementNotificationPage {
  /// The role list.
  roleScreen('RoleScreen'),
  /// One role, its permissions and members.
  roleDetailsPage('RoleDetailsPage'),
  /// Role edit form.
  editingRolePage('EditingRolePage'),
  ;

  const RoleManagementNotificationPage(this.key);

  /// The exact string stored in Firestore (`name_of_page`).
  final String key;

  static RoleManagementNotificationPage? fromKey(String key) {
