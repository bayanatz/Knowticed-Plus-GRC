...
import 'package:demo_app/features/notification/pin_notification.dart';
...
import 'clear_page_notification.dart';
...
class _NotificationContentState extends State<_NotificationContent> {
  ...
  Future<void> _handleCleanAll() async {
    ...
    final confirmed = await CustomConfirmationDialog.show(
      ...
      lottieAsset: 'assets/lottie/Simple Trash Clear.json',
      confirmText: s.yes,
      cancelText: s.no,
      lottieSize: 120.sp,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: isMobile
                    ...
                    child: CustomSvg(
                      assetPath:
                      "assets/notification_module/clean_icon_all.svg",
                      width: 20.w,
                      height: 20.h,
                      ...
                      Row(
                        children: [
                          customButtonWithImage(
                            ...
                            radius: 4.r,
                            image:
                            "assets/notification_module/new_pin_icon.svg",
                            widthImage: 16.sp,
                            heightImage: 16.sp,
                            colorBorder: Colors.transparent,
                          ),
                          ...
                          customButtonWithImage(
                            ...
                            radius: 4.r,
                            image:
                            "assets/notification_module/new_view_icon.svg",
                            widthImage: 16.sp,
                            heightImage: 16.sp,
                            colorBorder: Colors.transparent,
                          ),
