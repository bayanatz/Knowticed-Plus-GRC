...
import 'package:demo_app/features/notification/presentation/ui/widgets/custom_tab_ar.dart';
...
// REMOVED_MODULE: import 'package:demo_app/external/knowledge_hub_module/core/theming/new_theme.dart';
// REMOVED_MODULE: import 'package:demo_app/features/knowledge_hub_module/core/app_multi_select_drop_down.dart';
import 'package:demo_app/core/custom/31-custom_multi_select_dropdown.dart';
import 'package:demo_app/core/theme/app_colors.dart';
import 'package:demo_app/features/employee/presentation/controller/main_core_employee_controller.dart';
// REMOVED_MODULE: import 'package:demo_app/external/todo_module/core/components/other_components/flutter_switch.dart';
import 'package:demo_app/features/notification/data/models/notification_modle.dart';
...
import 'package:demo_app/features/notification/presentation/ui/pages/mobile/notification_edit_page.dart';
                      ...
                      children: [
                        if (!isEditMode)
                          customButtonWithImageMas(
                            ...
                            image: isMobile
                                ? "assets/edit.svg"
                                : "assets/icons_assets/main_icons_assets/Access_icons.svg",
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        if (item.hasEmail)
                                          CustomSvg(
                                            assetPath:
                                            "assets/icons_assets/notification_assets/notification_msg.svg",
                                            width: 20.w,
                                            height: 20.h,
                                            color: isSelected
                                                ? AppColors.textButton
                                        ...
                                        if (item.hasPush)
                                          CustomSvg(
                                            assetPath:
                                            "assets/icons_assets/notification_assets/notification_phone.svg",
                                            width: 20.w,
                                            height: 20.h,
                                            color: isSelected
                                                ? AppColors.textButton
