...
class _NotificationContentState extends State<_NotificationContent> {
  ...
  Future<void> _handleCleanAll() async {
    ...
    final confirmed = await CustomConfirmationDialog.show(
      context: context,
      title: s.cleaningNotifications,
      message: s.areYouSureYouWantToCleanAll,
      lottieAsset: 'assets/lottie_assets/notification_lottie_assets/Simple Trash Clear.json',
      confirmText: s.yes,
      cancelText: s.no,
      lottieSize: 120.sp,
    ...
    if (confirmed) {
      ...
      if (context.mounted) {
        showSuccessMaster(
          ...
          title: s.allNotificationsCleared,
          message: s.youSuccessfullyCleanedAllNotification,
          ...
          Row(
            children: [
              customButtonWithImage(
                ...
                image: "assets/icons_assets/notification_assets/cleared.svg",
                widthImage: 22.sp,
                heightImage: 22.sp,
              ...
              customButtonWithImage(
                ...
                space: 8.sp,
                radius: 8.r,
                image: "assets/icons_assets/notification_assets/pin_icon_svg.svg",
                widthImage: 22.sp,
                heightImage: 22.sp,
                colorBorder: Colors.transparent,
              ),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: isMobile
                    ...
                    child: CustomSvg(
                      assetPath:
                      "assets/icons_assets/notification_assets/clean_icon_all.svg",
                      width: 20.w,
                      height: 20.h,
                  ...
                  Column(
                    children: [
                      customButtonWithImage(
                        ...
                        padding: EdgeInsets.symmetric(horizontal: 25.5.sp),
                        height: 25.h,
                        color: AppColors.primary,
                        svgColor: AppColors.textButton,
                      ...
                      Row(
                        children: [
                          customButtonWithImage(
                            ...
                            radius: 4.r,
                            image:
                            "assets/icons_assets/notification_assets/new_pin_icon.svg",
                            widthImage: 16.sp,
                            heightImage: 16.sp,
                            colorBorder: Colors.transparent,
                          ),
                          ...
                          customButtonWithImage(
                            ...
                            radius: 4.r,
                            image:
                            "assets/icons_assets/notification_assets/new_view_icon.svg",
                            widthImage: 16.sp,
                            heightImage: 16.sp,
                            colorBorder: Colors.transparent,
                          ),
