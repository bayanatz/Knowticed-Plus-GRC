...
// REMOVED_MODULE: import 'package:grc_module/core/helper/organization_chart_module/presentation/controller/employee_controller.dart';
// REMOVED_MODULE: import 'package:grc_module/features/events/controllers/events_controllers/event_controller.dart';
// REMOVED_MODULE:   import 'package:grc_module/features/skeleton/authentication/welcome_screen/views/mobile_view/nav_bar.dart';
  ...
  // REMOVED_MODULE: import '../../../../services_app_module/core/di/injection.dart';
  import 'package:grc_module/core/network/get_base_url.dart';
  import 'package:grc_module/features/notification/presentation/controller/notification_controller_cubit_main_core.dart';
  ...
  import 'package:grc_module/features/home/h1_home_page/presentation/ui/pages/main_responnsive.dart';
  import 'package:grc_module/features/home/h2_nav_bar/presentation/controller/nav_bar_cubit.dart';
  import 'package:grc_module/features/notification/data/data_source/subsecration.dart';
  ...
  class LoginController extends GetxController {
    ...
    LoginController([CompanyCubit? companyCubit])
  ...
  // Apply this change to the login() method:
        ...
        String password) async
    {
      ...
      try {
        ...
        //     employee!.role.last == 'hr';
        //
        // print("\n🔹 AppDrawerCubit.isOwner: ${AppDrawerCubit.isOwner}");
        // print("🔹 AppDrawerCubit.isHr: ${AppDrawerCubit.isHr}");
        ...
        final signedInEmployee = addEmployeeController.employee;
        if (signedInEmployee != null && context.mounted) {
          try {
            await MessagingInterfaceImplementation()
                .useGroupAndSingleMessaging(context, signedInEmployee);
            print("   ✅ Messaging initialized");
          } catch (e) {
            // Messaging must never block sign-in.
            print("   ⚠️ Messaging init failed: $e");
          }
        } else {
          print("   ⚠️ Skipping messaging init - no employee record");
        }
        ...
        if (isMobileSize) {
          ...
          if (Get.isRegistered<AppDrawerCubit>()) {
            ...
            print("🗑️ [NAV] Removed AppDrawerCubit (mobile mode)");
          }
        } else {
          ...
          if (Get.isRegistered<NavBarCubit>()) {
            ...
            print("🗑️ [NAV] Removed NavBarCubit (desktop mode)");
          }
        }
