...
import 'package:demo_app/features/roles/role_management/domain/enums/form/form_permissions_sections.dart';
import 'package:demo_app/features/roles/role_management/domain/enums/inventory/inventory_permissions_sections.dart';
...
class RoleModel {
  ...
  static const String FORM_BUILDER_MODULE_KEY = 'Form_Builder_Module';
    ...
    return RoleModel(
      ...
      messageModule: map[MESSAGE_MODULE_KEY] != null
        ...
        constructedAdminSections: _getAdminSections(
            map[MESSAGE_MODULE_KEY], MessagesPermissionsSections.values),
      ...
      noteModule: map[NOTE_MODULE_KEY] != null
        ...
        _getSectionsPermissions(map[NOTE_MODULE_KEY], []),
          ...
          : null,
      formBuilderModule: map[FORM_BUILDER_MODULE_KEY] != null
          ? ModulePermissionModel.fromMap(
        map[FORM_BUILDER_MODULE_KEY],
        constructedAdminSections: _getAdminSections(
            map[FORM_BUILDER_MODULE_KEY], FormPermissionsSections.values),
        constructedSectionsPermissions: _getSectionsPermissions(
            map[FORM_BUILDER_MODULE_KEY], FormPermissionsSections.values),
      )
          : null,
      ...
      dataGRCModule: map[DATA_GRC_MODULE_KEY] != null
        ...
        constructedAdminSections: _getAdminSections(
            map[DATA_GRC_MODULE_KEY], QiyasPermissionsSections.values),
        constructedSectionsPermissions: _getSectionsPermissions(
            map[DATA_GRC_MODULE_KEY], QiyasPermissionsSections.values),
      )
          : null,
      ...
      inventoryModule: map[INVENTORY_MODULE_KEY] != null
        ...
        constructedAdminSections: _getAdminSections(
            map[INVENTORY_MODULE_KEY],
            InventoryPermissionsSections.values),
        constructedSectionsPermissions: _getSectionsPermissions(
            map[INVENTORY_MODULE_KEY],
            InventoryPermissionsSections.values),
      )
...
class RoleHistoryModel {
  ...
  static List<String> _extractModulesFromOldStructure(Map<String, dynamic> map) {
    ...
    Map<String, String> oldToNewModuleMap = {
      ...
      'Form_Builder_Module': 'form_builder',
      'Role_Module': 'roles',
      'HR_Module': 'hr',
