                      ...
                      children: [
                            ...
                            child: Row(children: [
                              Expanded(child: GestureDetector(onTap: () => _selectDate(context),
                                child: ColumnRequestData(fillColor: fieldBg, title: "Start Date", textController: startDate,
                                  ...
                                  hasPrefix: true, hasSuffix: true, suffixUrl: "assets/icons/newCalenderFixed.svg"))),
                              ...
                              Expanded(child: GestureDetector(onTap: () => _selectDate(context),
                                child: ColumnRequestData(fillColor: fieldBg, title: "End Date", textController: endDate,
                                  ...
                                  enabled: false, hasPrefix: true, hasSuffix: true, suffixUrl: "assets/icons/newCalenderFixed.svg"))),
                            ])),
                          Row(children: [
                            Expanded(child: GestureDetector(onTap: () => showDialog(context: context,
                              ...
                              child: ColumnRequestData(fillColor: fieldBg, title: "Start Time", isTextField: true,
                                ...
                                hasSuffix: true, suffixUrl: "assets/icons/newTimeIconFixed.svg", controllerState: (_) {}, maxlength: 120))),
                            SizedBox(width: 0.02.w),
                            Expanded(child: GestureDetector(onTap: () => showDialog(context: context,
                                builder: (_) => CupertinoTimePicker(onDateTimeChanged: (_) {})),
                        ...
                        if (widget.isSetting == true) ...[
                          ...
                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            _sec(optionsD, "Additional Information", 'assets/icons/add_info_title.svg', AdditionalInfoUpdate()),
                            _sec(optionsD, "Health Insurance", 'assets/icons/Hospital.svg', const HealthInsuranceUpdate()),
                            _sec(optionsD, "Emergency Contact Information", 'assets/icons/UsersGroup.svg', const EmergencyContactInfoUpdate()),
                            _sec(optionsD, "Personal Data", 'assets/icons/personalInfo.svg', const PersonalDataUpdate()),
                            _sec(optionsD, "Contact Information", 'assets/icons/contactInfoPhone.svg', ContactInfoUpdate()),
                            _sec(optionsD, "Location Information", 'assets/icons/LocationInfo.svg', LocationInfoUpdate()),
                          ]),
                        ],
                        if (widget.isSetting != true)
