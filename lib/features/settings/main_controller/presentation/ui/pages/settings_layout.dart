...
import 'package:grc_module/features/settings/main_controller/presentation/ui/widgets/shared/custom_cards.dart';
...
import 'package:grc_module/features/settings/main_controller/presentation/ui/widgets/shared/settings_appbar.dart';
...
import 'package:grc_module/features/settings/se3_company/presentation/ui/widgets/sections/comapny_info.dart';
                                          ...
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              onTap: isMobile
                                                ...
                                                _navigateToScreen(context, PersonalInfoScreen(), S.of(context).personalInformation);
                                              }
                                        ...
                                        if (hasHealthInsurance)
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              selectIndex: settingsController.selectedContainerIndex,
                                              onTap: isMobile
                                                  ? () => _navigateToScreen(context, SettingsHealthInsurance(), S.of(context).healthInsurance)
                                                  : null,
                                            ),
                                          ),
                                        if (hasSocialInfo)
                                        ...
                                        if (hasRequests)
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              selectIndex: settingsController.selectedContainerIndex,
                                              onTap: isMobile
                                                  ? () => _navigateToScreen(context,  MyRequestPage(), S.of(context).requests)
                                                  : null,
                                            ),
                                          ),
                                      ],
                                    ...
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          //         height: 18.h,
                                          //         fit: BoxFit.fill,
                                          //         'assets/icons_assets/settings_assets/branding_theme_badge.svg', // Reusing same icon, or create a new one
                                          //         color: settingsController.selectedContainerIndex == 17
                                          //             ? AppColors.secondaryPrimary
                                          //             : AppColors.secondaryPrimary
                                          //     ),
                                          ...
                                          if (hasCompanyInfo)
                                            Container(
                                              ...
                                              child: CustomCard(
                                                ...
                                                selectIndex: settingsController.selectedContainerIndex,
                                                onTap: isMobile
                                                    ? () => _navigateToScreen(context, CompanyScreenInfo(), S.of(context).companyInformation)
                                                    : null,
                                              ),
                                            ),
                                        ],
                                        ...
                                        if (hasLanguage)
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              selectIndex: settingsController.selectedContainerIndex,
                                              onTap: isMobile
                                                  ? () => _navigateToScreen(context, const LanguageScreen(), S.of(context).language)
                                                  : null,
                                            ),
                                          ),
                                        if (hasCommentsAndFeedbacks)
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              selectIndex: settingsController.selectedContainerIndex,
                                              onTap: isMobile
                                                  ? () => _navigateToScreen(context, const CommentsAndFeedbackScreen(), S.of(context).commentsAndFeedbacks)
                                                  : null,
                                            ),
                                          ),
                                        if (hasAboutApp)
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              selectIndex: settingsController.selectedContainerIndex,
                                              onTap: isMobile
                                                  ? () => _navigateToScreen(context, const AboutThisAppScreen(), S.of(context).aboutThisApp)
                                                  : null,
                                            ),
                                          ),
                                        if (hasTermsConditions)
                                          Container(
                                            ...
                                            child: CustomCard(
                                              ...
                                              selectIndex: settingsController.selectedContainerIndex,
                                              onTap: isMobile
                                                  ? () => _navigateToScreen(context, const TermsConditions(), S.of(context).termsAndConditions2)
                                                  : null,
                                            ),
                                          ),
