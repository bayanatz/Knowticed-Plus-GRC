...
class CompanyController extends GetxController with StateMixin {
  ...
  // ✅ NEW: Sync GetStorage from Firebase
  // ✅ NEW: Sync GetStorage from Firebase
  ...
  // ✅ NEW: Clear branding from GetStorage
  ...
  // ✅ FIXED: Populate controllers using correct nested model structure
  ...
  // ✅ FIXED: Update company information using correct nested model structure
