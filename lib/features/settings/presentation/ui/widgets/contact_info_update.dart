...
class ContactInfoUpdate extends StatefulWidget {
  final bool isRequestMobile;
  ContactInfoUpdate({this.isRequestMobile = false, super.key});

  @override
  State<ContactInfoUpdate> createState() => _ContactInfoUpdateState();
}

class _ContactInfoUpdateState extends State<ContactInfoUpdate> {
