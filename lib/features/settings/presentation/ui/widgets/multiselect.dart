...
import 'package:demo_app/features/settings/presentation/ui/widgets/selection_chip.dart';
    ...
    return CompositedTransformTarget(
      ...
      child: Focus(
        ...
        child: InkWell(
          ...
          onTap: _toggleFocus,
          child: Container(
            height: widget.chipConfig.wrapType == WrapType.wrap ? null : 22,
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            padding: EdgeInsets.symmetric(
              vertical:
                  MediaQuery.of(context).size.shortestSide > 600 ? 0 : 0.002.h,
                 
            ),
            child: Container(
              
              child: _buildChip(option, widget.chipConfig)),
          );
        },
      );
    }
              ...
              child: Material(
                  ...
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.all(
                      Radius.circular(widget.dropdownBorderRadius ?? 8),
                    ),
                  ),
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      color: widget.dropdownBackgroundColor ?? Colors.red,
                      borderRadius: widget.dropdownBorderRadius != null
                          ? BorderRadius.circular(widget.dropdownBorderRadius!)
                          : null,
                    ),
      ...
      title: Row(
        children: [
          Padding(
            ...
            child: _getSelectedIcon(isSelected, primaryColor) ?? SizedBox(),
          ),
          SizedBox(
