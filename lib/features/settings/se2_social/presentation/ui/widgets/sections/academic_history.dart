...
class _AcademicHistoryState extends State<AcademicHistory> {
  ...
  /// of the app. The "key" values are persisted, so they stay untranslated.
  List<Map<String, String>> _getDegreeItems(BuildContext context) {
    return [
      {
        "key": "bachelor",
        "value": FormatHelper.capitalize(S.of(context).bachelorDegree),
      },
      {
        "key": "master",
        "value": FormatHelper.capitalize(S.of(context).masterDegree),
      },
      {
        "key": "phd",
        "value": FormatHelper.capitalize(S.of(context).phdDegree),
      },
      {
        "key": "diploma",
        "value": FormatHelper.capitalize(S.of(context).diploma),
      },
      {
        "key": "certificate",
        "value": FormatHelper.capitalize(S.of(context).certificate),
      },
    ];
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          // Header
          SettingsHeader(
            imagePath: 'assets/icons_assets/settings_assets/academic_history_graduation.svg',
