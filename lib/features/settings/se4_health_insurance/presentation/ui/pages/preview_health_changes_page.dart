...
class _PreviewHealthInsuranceChangesPageState extends State<PreviewHealthInsuranceChangesPage> {
      ...
      ) async
  {
    ...
    showConfirmationDialog(
      lottiePath: 'assets/lottie_assets/roles_lottie_assets/createServices.json',
      ...
      onConfirm: () async {
        ...
        try {
          ...
          // Close all open dialogs and services_management_module
          int closeCount = 0;
          ...
          print('DEBUG - Closed $closeCount services_management_module/dialogs');
