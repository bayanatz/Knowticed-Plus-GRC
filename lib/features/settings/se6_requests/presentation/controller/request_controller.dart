...
import 'package:grc_module/features/home/h2_nav_bar/presentation/ui/pages/nav_bar.dart';
...
class RequestController extends GetxController with StateMixin {
  ...
  Future createRequest(
    ...
    systemLogsController
        .systemLogsAction("request to change personal info");
  ...
  void updateRequest(String status, RequestsModel requestsModel) async {
    {
      ...
      // Update the controller state.
      update();
      systemLogsController.systemLogsAction("update request status");
    }
  }
